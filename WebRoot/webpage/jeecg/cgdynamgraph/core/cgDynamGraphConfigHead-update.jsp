...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="cgDynamGraphConfigHeadController.do?doUpdate">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value"><input id="code" name="code" type="text" style="width: 150px" class="inputxt" datatype="*" value='${cgDynamGraphConfigHeadPage.code}'> <span class="Validform_checktip"></span></td>
			<td align="right"><label class="Validform_label"><t:mutiLang langKey="common.name"/> :</label></td>
			<td class="value"><input id="name" name="name" type="text" style="width: 150px" class="inputxt" datatype="*" value='${cgDynamGraphConfigHeadPage.name}'> <span class="Validform_checktip"></span></td>
            <td align="right"><label class="Validform_label"><t:mutiLang langKey="common.dynamic.dbsource"/> :</label></td>
            <td class="value"><t:dictSelect field="dbSource" dictTable="t_s_data_source" dictField="DB_KEY" dictText="DB_KEY" defaultVal="${cgDynamGraphConfigHeadPage.dbSource}" /><span class="Validform_checktip"></span></td>
        </tr>
		<tr>
			<td align="right"><label class="Validform_label"><t:mutiLang langKey="query.sql"/>:</label></td>
			<td class="value" colspan="5"><textarea rows="5" cols="150" id="cgrSql" name="cgrSql" datatype="*">${cgDynamGraphConfigHeadPage.cgrSql}</textarea> <span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="5"><textarea rows="3" cols="150" id="content" name="content" datatype="*">${cgDynamGraphConfigHeadPage.content}</textarea> <span class="Validform_checktip"></span></td>
		</tr>
		<tr>
			<td align="right"><label class="Validform_label">图表类型:</label></td>
			<td class="value"><t:dictSelect field="graphType" typeGroupCode="graphType" hasLabel="false"  defaultVal="${cgDynamGraphConfigHeadPage.graphType}" /><span class="Validform_checktip"></span></td>
			<td align="right"><label class="Validform_label">数据结构类型:</label></td>
			<td class="value" colspan="3"><t:dictSelect field="dataStructure" typeGroupCode="fieldtype" hasLabel="false" defaultVal="${cgDynamGraphConfigHeadPage.dataStructure}" /> <span class="Validform_checktip"></span></td>
        </tr>
...
<table style="display: none">
	<tbody id="add_cgDynamGraphConfigItem_table_template">
		<tr>
			...
			<td align="left"><t:dictSelect field="cgDynamGraphConfigItemList[#index#].fieldType" type="list" extendJson="{style:'width:80px'}" typeGroupCode="fieldtype" defaultVal="String" hasLabel="false" title="common.text.type"></t:dictSelect></td>
			...
			<td align="left"><t:dictSelect field="cgDynamGraphConfigItemList[#index#].SMode" type="list" extendJson="{style:'width:90px'}" typeGroupCode="searchmode" defaultVal="" hasLabel="false" title="common.query.module"></t:dictSelect></td>
			...
			<td align="left"><t:dictSelect field="cgDynamGraphConfigItemList[#index#].SFlag" type="list" extendJson="{style:'width:60px'}" typeGroupCode="yesorno" defaultVal="" hasLabel="false" title="common.isquery"></t:dictSelect></td>
		</tr>
	</tbody>
</table>
<table style="display: none">
