...
<div region="center" style="padding:0px;border:0px"><t:datagrid name="jeecgOrderMainList" title="订单信息" actionUrl="jeecgOrderMainController.do?datagrid" idField="id" fit="true">
