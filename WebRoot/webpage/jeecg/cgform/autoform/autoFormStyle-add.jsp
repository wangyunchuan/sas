...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="autoFormStyleController.do?doAdd" tiptype="1">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value" style="width:85%;">
					     	 <input id="styleDesc" name="styleDesc" type="text" style="width: 25%" class="inputxt" datatype="*" ajaxurl="autoFormStyleController.do?checkStyleNm">
